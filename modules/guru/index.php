...
<head>
    ...
    <title>Data Guru - SMA TUNAS HARAPAN</title>
    ...
    <div class="card shadow border-0">
        ...
        <div class="card-header bg-white border-0 pt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mt-2">
                <div>
                    <h4 class="fw-bold mb-0"><i class="fas fa-chalkboard-teacher me-2 text-primary"></i>Data Guru</h4>
                    <small class="text-muted">Manajemen data guru SMA Tunas Harapan</small>
                </div>
        ...
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="detail.php?id=<?= $row['id_guru']; ?>" class="btn btn-info btn-sm btn-action" title="Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="edit.php?id=<?= $row['id_guru']; ?>" class="btn btn-warning btn-sm btn-action" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a onclick="return confirm('Yakin ingin menghapus guru <?= $row['nama_guru']; ?>?')" 
                                   href="hapus.php?id=<?= $row['id_guru']; ?>" 
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Tambahkan data guru baru sekarang</p>
                    <a href="tambah.php" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Tambah Guru</a>
                </div>
            <?php endif; ?>

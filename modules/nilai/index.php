...
<nav class="navbar navbar-expand-lg bg-primary shadow-sm py-3">
    <div class="container-fluid">
        <span class="navbar-brand text-white">
            <i class="fas fa-school me-2"></i>SMA TUNAS HARAPAN
        </span>
            ...
            <div class="d-flex justify-content-between align-items-center mt-2">
                <div>
                    <h4 class="fw-bold mb-0">
                        <i class="fas fa-book me-2 text-success"></i>Data Nilai Siswa
                    </h4>
        ...
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a onclick="return confirm('Yakin ingin menghapus data nilai ini?')" 
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Silakan tambahkan data nilai siswa</p>
